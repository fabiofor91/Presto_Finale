<div>
    <form wire:submit.prevent="store">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('title') is-invalid @enderror" id="exampleInputTitle" placeholder="Inserisci il tuo titolo" wire:model.live="title">
            @error('title')
                ...
                <div class="col-12">
                    ...
                    <div class="row border border-4 border-info rounded shadow py-4">
                        @foreach ($images as $key => $image)
                            <div class="col my-3">
                                <div class="h-50 w-50  mx-auto shadow rounnded" style="background-image: url({{$image->temporaryUrl()}})"> </div>
